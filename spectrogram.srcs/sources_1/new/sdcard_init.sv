...
// defines the maximum addr for RAM
parameter 			MAX_RAM_ADDRESS = 27'h0FFFFF;
// indicates if SD card is of high capacity
parameter			SDHC 				 = 1'b1;

// internal signals for SD card operations and state machine control
logic 				sd_read_block;
logic				sd_busy;
logic				sd_data_rdy;
logic				sd_data_next;
...
// registers for RAM addr, data, and byte counter
...
// RAM addr output -> internal register
