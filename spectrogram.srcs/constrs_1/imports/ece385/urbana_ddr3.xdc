...
# PWM Output for Left Channel
set_property IOSTANDARD LVCMOS33 [get_ports pwm_out_left]
set_property PACKAGE_PIN B13 [get_ports pwm_out_left]

# PWM Output for Right Channel
set_property IOSTANDARD LVCMOS33 [get_ports pwm_out_right]
set_property PACKAGE_PIN B14 [get_ports pwm_out_right]
